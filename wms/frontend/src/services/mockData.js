export const initialData = {
  ...
  financialTransactions: [
    ...
    },
    {
      ...
      paidAmount: 0,
      debtAmount: 4 * 26000000 + 20 * 300000,
      referenceId: 'dvy-20241003',
      referenceType: 'Delivery',
      date: '2024-09-01',
      paymentDueDate: '2024-10-01',
      status: 'OVERDUE',
      note: 'Khách nợ từ phiếu xuất dvy-20241003 (Đã quá hạn)',
    },
    {
      id: 'ft-004',
      partnerId: 'cus-smartshop',
      partnerName: 'Smart Shop Wholesale',
      type: 'receivable',
      amount: 30 * 30000,
      paidAmount: 0,
      debtAmount: 30 * 30000,
      ...
      status: 'UNPAID',
      note: 'Giao dịch mới chưa thanh toán',
    },
  ],
};
